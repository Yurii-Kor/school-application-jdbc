...
class GroupValidatorTest {
    private static final String VALID_GROUP_NAME_SIMPLE = "AB-12";
    private static final String VALID_GROUP_NAME_LONG = "Mathematics-101";

    private static final String INVALID_GROUP_NAME_NO_HYPHEN = "AB12";
    private static final String INVALID_GROUP_NAME_NON_DIGIT_AFTER_HYPHEN = "AB-1A";
    private static final String INVALID_GROUP_NAME_EMPTY = "";
    private static final String INVALID_GROUP_NAME_NULL = "null";
    private static final String INVALID_GROUP_NAME_HYPHEN_WITHOUT_DIGITS = "AB-";
    private static final String INVALID_GROUP_NAME_HYPHEN_WITHOUT_LETTERS = "-12";
    private static final String INVALID_GROUP_NAME_ADDITIONAL_SYMBOLS = "AB-12-34";
    ...
    @ParameterizedTest(name = "GroupName: {0} | Expected: {1}")
    @CsvSource({
